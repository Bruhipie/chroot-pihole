...
curl -o ubuntu.tar.gz https://cdimage.ubuntu.com/ubuntu-base/releases/22.04.4/release/ubuntu-base-22.04.4-base-arm64.tar.gz
...
rsync -av $CURRDIR/pam.d/ $UBUNTUDIR/etc/pam.d/ #To fix "Required key not found" while using groupadd
